...
export default {
  ...
  methods: {
    ...
    getCityAndCountry(position){
      ...
      apiUrl=`https://us1.locationiq.com/v1/reverse.php?key=pk.f7892d3ba8243f52de226fe620f36558&lat=${ position.coords.latitude }&lon=${ position.coords.longitude }&format=json`
