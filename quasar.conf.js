...
let API_LOCAL = 'http://localhost:3000',//http://localhost:3000/createPost
    API_PRODUCTION = 'https://quasagrambackendap.herokuapp.com'
...
module.exports = function (/* ctx */) {
  return {
    ...
    animations: ['backOutLeft', 'backInLeft'],
    ...
    pwa: {
      ...
      manifest: {
        name: `Quasagram-share your expereinces`,
